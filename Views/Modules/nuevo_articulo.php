...
<html lang="en">
<head>
    <title><?= empresa() ?> | Nuevo Articulo</title>
...
<div class="content-wrapper" style="min-height: 1604.8px;">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Nuevo Ariculo</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <!-- Default box -->
 <form action="" name="form_add_articulo" id="form_add_articulo">
...
<div class="card-body">
         <div class="row">
          <div class="col-sm-12">
              ...
              <input type="hidden" name="action" value="addArticulo">
      ...
      <div class="row">
          <div class="col-sm-12">
            ...
            <input type="text" name="descripcion" id="descripcion" class="form-control" required="" maxlength="100" onkeyup="javascript:this.value=this.value.toUpperCase();">
          </div>
      </div>
 <!-- /.inicio -->
            <div class="row">
    ...
    <?php 
       ...
       {?>
        <option value="<?= $row_categoria['id_categoria'] ?>"><?=$row_categoria['nombre_categoria']?></option>;
       <?php  } ?>
  </select>
          </div>
           <div class="col-sm-6">
    ...
    <?php 
       ...
       {?>
        <option value="<?= $row_marca['id_marca'] ?>"><?=$row_marca['nombre_marca']?></option>;
       <?php  } ?>
  </select>
          </div>
      </div>
 <!-- /.fin -->
   ...
   <select class="form-control select2" style="width: 100%;" name="unidad" id="unidad">
    ...
    <?php 
       ...
       {?>
        <option value="<?= $row_unidad['id_unidad'] ?>"><?=$row_unidad['nombre_unidad']?></option>;
       <?php  } ?>
  </select>
          </div>
           <div class="col-sm-6">
    ...
    <?php 
       ...
       {?>
        <option value="<?= $row_afectacion['id_tipo_afectacion'] ?>"><?=$row_afectacion['descripcion_tipo_afectacion']?></option>;
       <?php  } ?>
  </select>
          </div>
      </div>
      <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text" onkeypress="return valideKey(event);" oninput='input(this)' name="precio_compra" id="precio_compra" class="form-control text-right" required="" value="0.00">
          </div>
           <div class="col-sm-6">
              <label for="">Precio Venta</label>
   
            <input type="text" onkeypress="return valideKey(event);" oninput='input(this)' name="precio_venta" id="precio_venta" class="form-control text-right" required="" value="0.00">
          </div>
      </div>
...
<script src="Assets/js/funciones_articulo.js"></script>
</body>
</html>
