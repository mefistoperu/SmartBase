              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="row">
                    ...
                    <table id="tabla" class="table table-striped table-bordered  nowrap no-footer" style="margin-left: 0px; width: 100%;">
