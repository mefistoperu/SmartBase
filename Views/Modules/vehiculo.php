...
$query_data = "SELECT * FROM tbl_gre_vehiculo WHERE idempresa='$empresa'";
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">Vehiculo </h2>
                </div>
                <div class="col-auto">
                      ...
                      <div class="col-md-12">
                        <div class="card shadow">
                          <div class="card-header">
                             <h2><button type="button" class="btn btn-dark" data-toggle="modal" data-target="#ModalCategoria"><i class="fe fe-plus-circle"></i> Nuevo <i class="fe fe-truck"></i></button></h2>
                          </div>
                         <div class="card-body">
...
<?php include 'views/modules/modals/vehiculo.php' ?>
    <?php include 'views/template/pie.php' ?>
      
     
      <script src="assets/js/vehiculo.js"></script>
      <script src="assets/js/funciones_vehiculo.js"></script>
