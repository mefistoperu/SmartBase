...
$boton  = '';
  ...
  $query_data = "SELECT * FROM vw_tbl_venta_producto WHERE fecha BETWEEN '$fecha_ini' AND '$fecha_fin' and empresa = $empresa  ORDER BY fecha,tipocomp,serie,correlativo, producto";
