...
if(!empty($_POST))
{
    ...
    on c.codcliente = x.num_doc WHERE idempresa = $empresa AND vendedor=$vendedor AND tipocomp <>'99' AND fecha_emision BETWEEN '$fecha_ini' AND '$fecha_fin'";
...
else
{
    ...
    $fecha_fin = $hoy;
    $query_venta = "SELECT * FROM tbl_venta_cab AS c LEFT JOIN tbl_contribuyente as x
    on c.codcliente = x.num_doc WHERE idempresa = $empresa AND vendedor=$vendedor AND tipocomp <>'99'AND fecha_emision='$hoy'";
    $resultado_venta=$connect->prepare($query_venta);
    $resultado_venta->execute();
    $num_reg_venta=$resultado_venta->rowCount();
}
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="nueva_venta" type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Factura / Boleta</a></h2>
                    <h2><a href="nueva_nota_credito" type="button" class="btn btn-warning"><i class="fa fa-plus-circle"></i> Nota de Credito </a></h2>
