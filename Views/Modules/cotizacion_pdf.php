...
$query_cabecera = $connect->prepare("SELECT * FROM vw_tbl_coti_cab as c
...
//DETALLE
$query_detalle = $connect->query("SELECT * FROM vw_tbl_coti_det WHERE idventa=$factura ORDER BY item");
              ...
              <table class="table table-bordered border">
                <thead>
                  <tr>
                    ...
                    <th class="border1 text-center border3" width="20%">VIGENCIA</th>
                ...
                <tbody>';
                  ...
                  $output.='
                     <tr>
                       ...
                       <th class="text-left border3">'.$detalle->descripcion.'<br />'.$detalle->detalle.'</th>
...
$dompdf->load_html($output);
$dompdf->render();
$font = $dompdf->getFontMetrics()->getFont("Tahoma", "bold");
$pdf = $dompdf->output();
