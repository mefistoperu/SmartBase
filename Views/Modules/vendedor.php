...
$query_data = "SELECT * FROM vw_tbl_vendedor WHERE idempresa='$empresa'";
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">Vendedor </h2>
                </div>
                <div class="col-auto">
...
<?php include 'views/modules/modals/vendedor.php' ?>
    <?php include 'views/template/pie.php' ?>
      
     
      <script src="assets/js/vendedor.js"></script>
      <script src="assets/js/funciones_vendedor.js"></script>
