...
$query_data = "SELECT * FROM tbl_gre_conductor WHERE empresa='$empresa'";
...
<?php include 'views/modules/modals/chofer.php' ?>
    <?php include 'views/template/pie.php' ?>
      
     
      <script src="assets/js/chofer.js"></script>
      <script src="assets/js/funciones_chofer.js"></script>
