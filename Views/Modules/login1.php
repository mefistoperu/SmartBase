      ...
      <div class="row align-items-center h-100">
        <div class="col-lg-6 d-none d-lg-flex">
          <div class="row text-center">
            <div class="col-sm-12">
              <img src="https://static.vecteezy.com/system/resources/previews/000/670/494/large_2x/man-sitting-on-large-laptop-with-bill-coming-out-of-it-credit-card-and-coins-vector.jpg" alt="" width="80%">
            </div>
          </div>
        </div> <!-- ./col -->
        <div class="col-lg-6">
          ...
          <div class="form-group">
            ...
            <input type="text" id="ruc" name="ruc" class="form-control form-control-lg" placeholder="Ingresar Ruc" required="" autofocus="" maxlength="11">
          </div>
          <div class="form-group">
