...
$query_data = "SELECT * FROM vw_tbl_compras_sunat WHERE fecha_emision BETWEEN '$fecha_ini' AND '$fecha_fin' ORDER BY td,fecha_emision,serie,numero";
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">Registro de compras SUNAT </h2>
                </div>
                <div class="col-auto">
                          ...
                          <div class="card-header">
                            <form class="form-inline" method="POST">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <a href="<?=base_url()?>/ws_siscont_compras/<?=$fecha_ini?>/<?=$fecha_fin?>" class="btn btn-primary mr-3" <?=$boton?>><i class="fas fa-file-excel"></i> excel Siscont</a>
                                  </div>
                            </form>                 
