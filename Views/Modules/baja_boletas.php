...
$max_dias = date("Y-m-d",strtotime($hoy."- 90 days")); 
...
if(!empty($_POST))
{
    ...
    on c.idcliente = x.id_persona WHERE idempresa = $empresa  AND tipocomp ='03' AND fecha_emision = '$fecha_ini' AND feestado='1' ";
...
else
{
    ...
    $query_venta = "SELECT * FROM tbl_venta_cab AS c LEFT JOIN tbl_contribuyente as x
    on c.idcliente = x.id_persona WHERE idempresa = $empresa AND tipocomp ='03'AND fecha_emision='$hoy' AND feestado='1'";
    $resultado_venta=$connect->prepare($query_venta);
    $resultado_venta->execute();
    $num_reg_venta=$resultado_venta->rowCount();
}
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">Baja de Boletas </h2>
                </div>
                <div class="col-auto">
                    ...
                    <form method="POST" class="form-inline">
                     ...
                     <div class="col-sm-2">
                        ...
                        <button class="btn btn-success ml-3 mt-3 btn-block" type="submit">Listar CPE</button>
                         ...
                         <div class="card-body">
                    <form name="baja_boletas_cpe" id="baja_boletas_cpe">
                      <div class="col-sm-2">
                          <div class="row">
                        <button type="button" class="btn btn-primary ml-3 mt-3 btn-block" id="GenerarBajaBoletas" >Generar Baja</button>
                        <input type="hidden" name="action"  value="baja_cpe_boletas">
