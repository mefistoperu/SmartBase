<div id="deleteInsumo" class="modal fade deleteAlmacen" id="deleteSerie" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <form name="form_delete_insumo" id="form_delete_insumo">

    <div class="modal-content">
      

      <div class="modal-header bg-danger">
        <h4 class="modal-title" id="myModalLabel" style="color: white;">Anular Insumo</h4>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            ...
            <input type="hidden" name="delete_id_insumo" id="delete_id_insumo" value="">  
          </div>         
