                       ...
                       <?php while($row = $resultado_data->fetch(PDO::FETCH_ASSOC) ) { ?>
                          <tr>
                           <td width="10%"><?php echo $row['id'] ?></td>
                            ...
                            <td width="10%">
                              <button type="button" class="btn btn-primary rounded-circle" onclick="agregar('<?=$row['id']?>','<?php echo $row['nombre'] ?>','<?php echo $row['precio_venta'] ?>','<?php echo $row['afectacion'] ?>','<?php echo $row['costo'] ?>','<?php echo $row['factor'] ?>')"><i class="fa fa-plus"></i></button>
                            </td>
                          </tr>
                        <?php } ?>
                </tbody>
                       ...
                       <?php while($row1 = $resultado_data1->fetch(PDO::FETCH_ASSOC) ) { ?>
                          <tr>
                           <td width="10%"><?php echo $row1['id'] ?></td>
                            ...
                            <td width="10%">
                              <button type="button" class="btn btn-primary rounded-circle" onclick="agregar('<?=$row1['id']?>','<?php echo $row1['nombre'] ?>','<?php echo $row1['precio2'] ?>','<?php echo $row1['afectacion'] ?>','<?php echo $row1['costo'] ?>','<?php echo $row1['factor'] ?>')"><i class="fa fa-plus"></i></button>
                            </td>
                          </tr>
                        <?php } ?>
                </tbody>
