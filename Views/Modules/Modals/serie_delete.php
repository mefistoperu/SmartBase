<div class="modal fade deleteSerie" id="deleteSerie" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <form name="form_series_delete" id="form_series_delete">

    <div class="modal-content">

      <div class="modal-header bg-danger">
        <h4 class="modal-title" id="myModalLabel" style="color: white;">Anular Serie</h4>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            <input type="hidden" name="action"  value="delete_serie">
            <input type="hidden" name="delete_empresa" value="<?=$_SESSION["id_empresa"]?>">
            <input type="hidden" name="delete_id_serie" id="delete_id_serie" value="">  
          </div>         
