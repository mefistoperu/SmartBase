        ...
        <tbody>
          <?php foreach ($resultado1 as $res2) { ?>
            <tr>
              ...
              <td  class="text-center"><a class="btn btn-success" onclick="enviacliente4('<?php echo $res2->id_persona; ?>','<?php echo $res2->num_doc; ?>','<?php echo $res2->nombre_persona; ?>','<?php echo $res2->direccion_persona; ?>');"><i class="fe fe-check"></i></a></td>
            </tr>
          <?php } ?>
        </tbody>
