...
sum(oth) as oth,
sum(total) as total FROM vw_tbl_compras_sunat WHERE fecha_emision BETWEEN '$fecha_ini' and '$fecha_fin' AND  td<>'99' GROUP BY td");
//$query_doc->execute();
...
FROM vw_tbl_compras_sunat WHERE  fecha_emision BETWEEN '$fecha_ini' and '$fecha_fin' AND td<>'99'");
...
<body>
    ...
    <div class="container-fluid">
            ...
            <h2 class="text-center">REGISTRO DE COMPRAS DEL '.$fecha_ini.' AL '.$fecha_fin.'</h2>
            <hr>
             <table class="table table-bordered">
                      ...
                      <tbody>';
                        foreach ($resultado_doc as $doc) 
                        {
                           ...
                           $query_tdoc = $connect->query("SELECT * FROM vw_tbl_compras_sunat WHERE fecha_emision BETWEEN '$fecha_ini' and '$fecha_fin' AND  td='$tpdoc' ");
                           //$query_doc->execute();
...
//echo $output; exit();
$invoiceFileName = 'COMPRAS DEL '.$fecha_ini.' AL '.$fecha_fin.'.pdf';
$dompdf = new DOMPDF();
