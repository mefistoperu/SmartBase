...
{
  $query_data = "SELECT fecha FROM vw_tbl_ventas_diarias WHERE vendedor='$usuario' and fecha BETWEEN '$fecha_ini' AND '$fecha_fin'  and tipocomp='99'  GROUP by  fecha";
}
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Registro de Nota de Ventas</h3>
              </div>
                  ...
                  <div class="x_title">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <a href="<?=base_url()?>/rpt_ventas_diarias_pdf_nv/<?=$fecha_ini?>/<?=$fecha_fin?>/<?=$usuario?>" target="_blank" class="btn btn-danger" <?=$boton?>><i class="fa fa-file-pdf-o"></i></a>
                        </div>
                      </form>
                    </div>
                    ...
                    <table id="datatable-rptvtad" class="table table-striped table-bordered  nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                         <?php foreach($resultado_data as $data ){ ?>
                          ...
                          {
                            $query_tdoc = $connect->prepare("SELECT * FROM vw_tbl_ventas_diarias WHERE vendedor='$usuario' and fecha ='$fecha_dia' and tipocomp='99' ORDER BY tipocomp,serie");
