...
$query_totales = $connect->prepare("SELECT sum(if(tipocomp='07',-op_gravadas,op_gravadas)) as op_gravadas,
                            ...
                            FROM vw_tbl_ventas_diarias WHERE fecha BETWEEN '$fecha_ini' AND  '$fecha_fin' AND tipocomp<>'99'");
...
<body>
    ...
    <div class="container-fluid">
            ...
            <h2 class="text-center">REGISTRO DE VENTAS DIARIAS DEL '.$fecha_ini.' AL '.$fecha_fin.'</h2>
            <hr>
