...
function agregar(id,nombre,precio,afectacion,precio_compra,factor)
{
	...
	var fila='<tr id="fila'+cont+'">'+
	         ...
	         '<td>'+cont+'</td>'+
	          ...
	          '<td><input type="hidden" name="precio_compra[]" value="'+precio_compra+'"><input type="hidden" name="factor[]" value="'+factor+'"><input type="text" min="1" class="form-control input-sm" name="cantidad[]" id="cantidad[]" value="'+cantidad+'" onkeyup="modificarSubtotales()" onkeypress="return valideKey(event);" oninput="input(this)" ></td>'+
	          '<td><input type="text" min="1" class="form-control input-sm" name="cantidadu[]" id="cantidadu[]" value="'+cantidadu+'" onkeypress="return valideKey(event);" oninput="input(this)" onkeyup="modificarSubtotales()"></td>'+
...
function modificarSubtotales()
{
	...
	for(var i=0; i< cant.length;i++)
	{
		...
		inpS.value = (inpV.value*inpP.value*inpF.value + inpU.value*inpP.value);
