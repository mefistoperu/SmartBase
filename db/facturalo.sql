...
) ENGINE = MyISAM AUTO_INCREMENT = 182 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tbl_compra_cab` VALUES (181, 1, '01', 'F001', 00000002, '2022-02-05', '2022-02-05', NULL, '1', 0, 'PEN', 0.00000, 60.00000, 0.00000, 0.00000, 60.00000, '20494168651', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', 1);
...
) ENGINE = MyISAM AUTO_INCREMENT = 272 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = FIXED;
...
INSERT INTO `tbl_compra_det` VALUES (269, 181, 1, 7, 1.00, 20.00000, 20.00000, 0.00000, 18.00, 20.00000, 20.00);
INSERT INTO `tbl_compra_det` VALUES (270, 181, 2, 7, 1.00, 20.00000, 20.00000, 0.00000, 18.00, 20.00000, 20.00);
INSERT INTO `tbl_compra_det` VALUES (271, 181, 3, 7, 1.00, 20.00000, 20.00000, 0.00000, 18.00, 20.00000, 20.00);
...
-- ----------------------------
INSERT INTO `tbl_contribuyente` VALUES (40, 'J Y M SMART SOLUTIONS S.A.C.', 'CAL. PORTA NRO. 170 INT. 610 COM. SAN MIGUEL DE MIRAFLORES LIMA LIMA MIRAFLORES', 'MIRAFLORES', 'LIMA', 'LIMA', '6', '20603446748', 'demo@gmail.com', 1, NULL, NULL, NULL, NULL, 'bfbc3e9d429ffcc5c076aee44c8f7b5a');
INSERT INTO `tbl_contribuyente` VALUES (41, 'PENTARAMA EL PACIFICO S.A.', 'AV. JOSE PARDO NRO. 121 LIMA LIMA MIRAFLORES', 'MIRAFLORES', 'LIMA', 'LIMA', '6', '20548960771', 'demo@gmail.com', 1, NULL, NULL, NULL, NULL, '05288c4273e79b7a204b82108d8c9a74');
INSERT INTO `tbl_contribuyente` VALUES (42, 'PENTARAMA INVESTMENT S.A.', 'JR. ALFONSO UGARTE NRO. 1360 URB. LOS JARDINES SAN MARTIN SAN MARTIN TARAPOTO', 'TARAPOTO', 'SAN MARTIN', 'SAN MARTIN', '6', '20494168651', 'demo@gmail.com', 1, NULL, NULL, NULL, NULL, 'd91462f76215d3335cf07e8ce32eee38');
INSERT INTO `tbl_contribuyente` VALUES (43, 'VALVERDE CASTILLO JUAN MIGUEL', '-', 'MIRAFLORES', 'LIMA', 'LIMA', '1', '44168916', 'demo@gmail.com', 1, NULL, NULL, NULL, NULL, 'b6c1cb9bed46384ac9e1dbd30239522b');
...
CREATE TABLE `tbl_cta_cobrar`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 202 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tbl_cta_pagar`  (
  ...
  `empresa` int(5) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 140 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `tbl_empresas` VALUES (1, '10441689166', 'JUAN MIGUEL VALVERDE CASTILLO', 'CAL. IRIS 102 URB OLIMPO (ALT. CUADRA 12 AV LOS QUECHUAS)', 'ATE', 'LIMA', 'LIMA', '150101', 'jmvalverdec@gmail.com', 'MODDATOS', 'MODDATOS', '10441689166.pfx', '10441689166', '40111', '40111', '42121', '42122', '12121', '12122', '02', '03', '01', '04', 18.00, '12345', '2021-12-29', '2022-09-08', 'logo.jpg', 1, 'SI', 'NO');
...
-- ----------------------------
INSERT INTO `tbl_insumos` VALUES (4, 'CHOCOLATE PRINCESA', 4, 'NIU', 0.90000, 0.60000, 87.00000, '1', 1);
INSERT INTO `tbl_insumos` VALUES (5, 'LECHE GLORIA', 5, 'NIU', 3.00000, 2.50000, -4.00000, '1', 1);
...
CREATE TABLE `tbl_productos`  (
  ...
  `costo` decimal(10, 5) NULL DEFAULT NULL,
  `por1` decimal(10, 5) NULL DEFAULT NULL,
  `precio_venta` decimal(10, 5) NOT NULL DEFAULT 0.00000,
  `por2` decimal(10, 5) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `tbl_productos` VALUES (6, 'CHOCOLATE PRINCESA', '', 4, 'NIU', NULL, NULL, NULL, 1.00000, NULL, 0.90000, '10', '1', 1);
INSERT INTO `tbl_productos` VALUES (7, 'CHOCOLATE PRINCESA CAJ X 24', '', 4, 'NIU', NULL, NULL, NULL, 20.00000, NULL, 18.00000, '20', '1', 1);
INSERT INTO `tbl_productos` VALUES (8, 'GALLETA MOROCHA X6', '', 4, 'NIU', NULL, 5.00000, 5.00000, 5.25000, 10.00000, 5.50000, '10', '1', 1);
INSERT INTO `tbl_productos` VALUES (9, 'PRODUCTO DE PRUEBA', '', 5, 'NIU', 10, 5.00000, 5.00000, 52.50000, 4.00000, 52.00000, '10', '1', 1);
...
-- ----------------------------
INSERT INTO `tbl_series` VALUES (15, '01', 'F001', 00000048, 1, '1', '1');
INSERT INTO `tbl_series` VALUES (16, '03', 'B001', 00000012, 1, '1', '1');
INSERT INTO `tbl_series` VALUES (17, '01', 'F002', 00000001, 1, '1', '0');
INSERT INTO `tbl_series` VALUES (18, '07', 'FC01', 00000009, 1, '1', '1');
INSERT INTO `tbl_series` VALUES (19, '07', 'BC01', 00000001, 1, '1', '1');
INSERT INTO `tbl_series` VALUES (20, '99', 'NV01', 00000002, 1, '1', '1');
...
-- ----------------------------
INSERT INTO `tbl_usuarios` VALUES (1, '10441689166', '2fb53ce00477a55bcb91b64e3956ae4f', 'JUAN', 'VALVERDE', 1, '1', 8, 1);
INSERT INTO `tbl_usuarios` VALUES (2, 'CAJA01', '4ab84513540819974e2bf6d02f342674', 'SEBASTIAN', 'VALVERDE', 1, '1', 8, 3);
...
CREATE TABLE `tbl_venta_cab`  (
  ...
  INDEX `fk_cliente`(`codcliente`) USING BTREE,
  INDEX `fk_emisor`(`idempresa`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 253 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tbl_venta_cab
-- ----------------------------
INSERT INTO `tbl_venta_cab` VALUES (249, 1, '01', 'F001', 00000047, '2022-03-06', '2022-03-06', NULL, '1', 0, 'PEN', 0.00, 1.00, 0.00, 0.00, 1.00, '44168916', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', 1);
INSERT INTO `tbl_venta_cab` VALUES (250, 1, '03', 'B001', 00000010, '2022-03-06', '2022-03-06', NULL, '1', 0, 'PEN', 0.85, 0.00, 0.00, 0.15, 1.00, '44168916', 1, '', ' ha sido Aceptada por SUNAT', NULL, NULL, NULL, 'Ut/KL1t2HQYvnWqbC1AD6sR9J2A=', NULL, NULL, NULL, NULL, NULL, '1', 1);
INSERT INTO `tbl_venta_cab` VALUES (251, 1, '03', 'B001', 00000011, '2022-03-06', '2022-03-06', NULL, '1', 0, 'PEN', 0.00, 20.00, 0.00, 0.00, 20.00, '44168916', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', 1);
INSERT INTO `tbl_venta_cab` VALUES (252, 1, '03', 'B001', 00000011, '2022-03-06', '2022-03-06', NULL, '1', 0, 'PEN', 0.00, 20.00, 0.00, 0.00, 20.00, '44168916', 1, '', ' ha sido Aceptada por SUNAT', NULL, NULL, NULL, 'gD7dcRmh7PmgJcUkCKEbZHl19oE=', NULL, NULL, NULL, NULL, NULL, '1', 1);
...
CREATE TABLE `tbl_venta_det`  (
  ...
  INDEX `fk_venta`(`idventa`) USING BTREE,
  INDEX `fk_producto`(`idproducto`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 361 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = FIXED;

-- ----------------------------
-- Records of tbl_venta_det
-- ----------------------------
INSERT INTO `tbl_venta_det` VALUES (357, 249, 1, 6, 1.00, 1.00, 1.00, 0.00, 18.00, 1.00, 1.00);
INSERT INTO `tbl_venta_det` VALUES (358, 250, 1, 6, 1.00, 0.85, 1.00, 0.15, 18.00, 0.85, 1.00);
INSERT INTO `tbl_venta_det` VALUES (359, 251, 1, 7, 1.00, 20.00, 20.00, 0.00, 18.00, 20.00, 20.00);
INSERT INTO `tbl_venta_det` VALUES (360, 252, 1, 7, 1.00, 20.00, 20.00, 0.00, 18.00, 20.00, 20.00);
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_tbl_ventas_diarias` AS select `tbl_venta_cab`.`fecha_emision` AS `fecha`,`tbl_venta_cab`.`tipocomp` AS `tipocomp`,`tbl_venta_cab`.`serie` AS `serie`,min(`tbl_venta_cab`.`correlativo`) AS `desde`,max(`tbl_venta_cab`.`correlativo`) AS `hasta`,cast(sum(`tbl_venta_cab`.`op_gravadas`) as decimal(10,2)) AS `op_gravadas`,cast(sum(`tbl_venta_cab`.`op_inafectas`) as decimal(10,2)) AS `op_inafectas`,cast(sum(`tbl_venta_cab`.`op_exoneradas`) as decimal(10,2)) AS `op_exoneradas`,cast(sum(`tbl_venta_cab`.`igv`) as decimal(10,2)) AS `igv`,cast((((sum(`tbl_venta_cab`.`op_gravadas`) + sum(`tbl_venta_cab`.`op_inafectas`)) + sum(`tbl_venta_cab`.`op_exoneradas`)) + sum(`tbl_venta_cab`.`igv`)) as decimal(10,2)) AS `total` from `tbl_venta_cab` group by `tbl_venta_cab`.`tipocomp`;

-- ----------------------------
-- View structure for vw_tbl_ventas_sunat
-- ----------------------------
DROP VIEW IF EXISTS `vw_tbl_ventas_sunat`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_tbl_ventas_sunat` AS select `vc`.`fecha_emision` AS `fecha_emision`,`vc`.`fecha_vencimiento` AS `fecha_vencimiento`,`vc`.`tipocomp` AS `td`,if((`vc`.`tipocomp` = '01'),'FACTURA',if((`vc`.`tipocomp` = '03'),'BOLETA DE VENTA',if((`vc`.`tipocomp` = '07'),'NOTA DE CREDITO',if((`vc`.`tipocomp` = '08'),'NOTA DE DEBITO','NOTA DE VENTA')))) AS `nomdoc`,`vc`.`serie` AS `serie`,`vc`.`correlativo` AS `numero`,`co`.`tipo_doc` AS `doc`,`co`.`num_doc` AS `num_cli`,0.00 AS `valor_exportacion`,cast(`vc`.`op_gravadas` as decimal(10,2)) AS `op_gravadas`,cast(`vc`.`op_exoneradas` as decimal(10,2)) AS `op_exoneradas`,cast(`vc`.`op_inafectas` as decimal(10,2)) AS `op_inafectas`,0.00 AS `isc`,cast(`vc`.`igv` as decimal(10,2)) AS `igv`,0.00 AS `icbper`,0.00 AS `oth`,cast((((`vc`.`op_gravadas` + `vc`.`op_exoneradas`) + `vc`.`op_inafectas`) + `vc`.`igv`) as decimal(10,2)) AS `total`,`vc`.`tipocomp_ref` AS `tipo_ref`,`vc`.`serie_ref` AS `serie_ref`,`vc`.`correlativo_ref` AS `correlativo_ref`,`vc`.`idempresa` AS `empresa` from (`tbl_venta_cab` `vc` left join `tbl_contribuyente` `co` on((`vc`.`codcliente` = `co`.`num_doc`)));

-- ----------------------------
-- View structure for vw_tbl_venta_cab
-- ----------------------------
DROP VIEW IF EXISTS `vw_tbl_venta_cab`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_tbl_venta_cab` AS select `vc`.`id` AS `id`,`vc`.`idempresa` AS `idempresa`,`vc`.`tipocomp` AS `tipocomp`,if((`vc`.`tipocomp` = '01'),'FACTURA',if((`vc`.`tipocomp` = '03'),'BOLETA DE VENTA',if((`vc`.`tipocomp` = '07'),'NOTA DE CREDITO',if((`vc`.`tipocomp` = '08'),'NOTA DE DEBITO','NOTA DE VENTA')))) AS `nomdoc`,`vc`.`serie` AS `serie`,`vc`.`correlativo` AS `correlativo`,`vc`.`fecha_emision` AS `fecha_emision`,`vc`.`fecha_vencimiento` AS `fecha_vencimiento`,`vc`.`orden_compra` AS `orden_compra`,`vc`.`condicion_venta` AS `condicion_venta`,`vc`.`cuotas_credito` AS `cuotas_credito`,`vc`.`codmoneda` AS `codmoneda`,`vc`.`op_gravadas` AS `op_gravadas`,`vc`.`op_exoneradas` AS `op_exoneradas`,`vc`.`op_inafectas` AS `op_inafectas`,`vc`.`igv` AS `igv`,`vc`.`total` AS `total`,`vc`.`codcliente` AS `codcliente`,`vc`.`feestado` AS `feestado`,`vc`.`fecodigoerror` AS `fecodigoerror`,`vc`.`femensajesunat` AS `femensajesunat`,`vc`.`nombrexml` AS `nombrexml`,`vc`.`xmlbase64` AS `xmlbase64`,`vc`.`cdrbase64` AS `cdrbase64`,`vc`.`hash` AS `hash`,`vc`.`tipocomp_ref` AS `tipocomp_ref`,`vc`.`serie_ref` AS `serie_ref`,`vc`.`correlativo_ref` AS `correlativo_ref`,`vc`.`cod_motivo` AS `cod_motivo`,if((`vc`.`cod_motivo` = '01'),'FACTURA ELECTRONICA',if((`vc`.`cod_motivo` = '03'),'BOLETA DE VENTA ELECTRONICA','')) AS `nom_cod_motivo`,`vc`.`des_motivo` AS `des_motivo`,`vc`.`estado` AS `estado`,`vc`.`vendedor` AS `vendedor`,`tc`.`id_persona` AS `id_persona`,`tc`.`nombre_persona` AS `nombre_persona`,`tc`.`direccion_persona` AS `direccion_persona`,`tc`.`distrito` AS `distrito`,`tc`.`provincia` AS `provincia`,`tc`.`departamento` AS `departamento`,`tc`.`tipo_doc` AS `tipo_doc`,`tc`.`num_doc` AS `num_doc`,`tc`.`correo` AS `correo`,`tc`.`empresa` AS `empresa`,`tc`.`clave` AS `clave`,`tc`.`servidor_cpe` AS `servidor_cpe`,`tc`.`envio_automatico` AS `envio_automatico`,`tc`.`envio_resumen` AS `envio_resumen` from (`tbl_venta_cab` `vc` left join `tbl_contribuyente` `tc` on((`vc`.`codcliente` = `tc`.`num_doc`)));
